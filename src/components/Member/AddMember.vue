  ...
  <div style="height: 65vh;overflow: auto;">
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" >
      <el-form-item label="学号" prop="User_account">
        <el-input v-model="ruleForm.User_account" style="width:100%"></el-input>
      </el-form-item>
      <el-row type="flex" class="el-row">
        ...
        <el-col :span="12">
          <el-upload
              ...
              action="http://image.ccit.club/admin/uploading/selfie"
              :show-file-list="true"
              :headers="headers"
    ...
    // 添加按钮
     submitForm(ruleForm) {
      this.$refs.ruleForm.validate(async valid=> {
        if (!valid) return
        const ret = await this.$http.post("admin/user/add", this.ruleForm).catch(function (error){
        ...
        if (ret.data.code === 1){
          ...
          this.$message({showClose:true,message:ret.data.message,center:true,type:'error',duration:1500,onClose:()=>{
            }})
        }
      })
    },
